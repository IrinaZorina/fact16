...
echo "Математика средний бал: $srMat, сумма оценок $sumMat. <br>";
echo "Физика средний бал: $srPh, сумма оценок $sumPh.<br>";
echo "Химия средний бал: $srCh, сумма оценок $sumCh.<br>";
echo "Информатика средний бал: $srIn, сумма оценок $sumIn.<br>";
